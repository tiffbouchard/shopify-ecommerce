...
function commitMutations(mutations) {
  return _client.default.dataRequest('mutate', mutations, {
    visibility: 'async',
...
function checkoutPair(idPair) {
  ...
  var listenerEvents$ = (0, _getPairListener.getPairListener)(_client.default, idPair).pipe((0, _operators.share)());
