...
var editState = (0, _createMemoizer.memoize)((idPair, typeName) => {
  return (0, _operationArgs.operationArgs)(idPair, typeName).pipe((0, _operators.switchMap)((_ref) => {
    var draft = _ref.draft,
        published = _ref.published;
    return (0, _rxjs.combineLatest)([draft.snapshots$, published.snapshots$]);
  }), (0, _operators.map)((_ref2) => {
    var _ref3 = _slicedToArray(_ref2, 2),
        draftSnapshot = _ref3[0],
        publishedSnapshot = _ref3[1];
    ...
    return {
      ...
      liveEdit: (0, _isLiveEditEnabled.isLiveEditEnabled)(typeName)
    };
