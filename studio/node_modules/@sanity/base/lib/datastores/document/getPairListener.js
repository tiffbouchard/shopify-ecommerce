...
Object.defineProperty(exports, "MutationEvent", {
  enumerable: true,
  get: function get() {
    return _types.MutationEvent;
  }
});
...
function getPairListener(client, idPair) {
  ...
  })).pipe((0, _operators.concatMap)(event => event.type === 'welcome' ? fetchInitialDocumentSnapshots({
    publishedId,
    draftId
  ...
  function fetchInitialDocumentSnapshots(_ref) {
    var publishedId = _ref.publishedId,
        draftId = _ref.draftId;
    return client.observable.getDocuments([draftId, publishedId]).pipe((0, _operators.map)((_ref2) => {
