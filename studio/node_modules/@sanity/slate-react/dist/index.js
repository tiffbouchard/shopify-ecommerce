...
var Editable = function Editable(props) {
  ...
  useIsomorphicLayoutEffect(function () {
    ...
    if (hasDomSelection && hasDomSelectionInEditor && selection && slate.Range.equals(ReactEditor.toSlateRange(editor, domSelection), selection) && domSelection.focusNode !== editorElement // Added by Sanity for Chrome compatibility issues
    ) {
        return;
    ...
    if (newDomRange) {
      ...
      var leafEl = newDomRange.startContainer.parentElement; // Sanity: modified boundary

      var boundary = null;

      if (el.parentElement && el.parentElement.parentElement && el.parentElement.parentElement.parentElement) {
      ...
      if (selection) {
        try {
          var _Array$from$ = slicedToArray(Array.from(slate.Editor.nodes(editor, {
            at: selection.focus,
          ...
          if (block && slate.Editor.isVoid(editor, block)) {
            var element = ReactEditor.toDOMNode(editor, block);
      ...
      scrollIntoView(leafEl, {
        ...
        behavior: function behavior(actions) {
          return actions.forEach(function (_ref) {
            var el = _ref.el,
                top = _ref.top,
                left = _ref.left;
