...
var Editable = props => {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    if (hasDomSelection && hasDomSelectionInEditor && selection && Range.equals(ReactEditor.toSlateRange(editor, domSelection), selection) && domSelection.focusNode !== editorElement // Added by Sanity for Chrome compatibility issues
    ) {
        return;
    ...
    if (newDomRange) {
      ...
      if (selection) {
        try {
          var [block] = Array.from(Editor.nodes(editor, {
            at: selection.focus,
            match: n => Editor.isBlock(editor, n)
          }))[0];

          if (block && Editor.isVoid(editor, block)) {
      ...
      scrollIntoView(leafEl, {
        ...
        behavior: actions => actions.forEach((_ref) => {
          var {
            el,
            top,
            left
