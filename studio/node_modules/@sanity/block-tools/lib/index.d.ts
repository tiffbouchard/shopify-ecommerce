...
declare const blockContentFunctions: {
     ...
     * @returns {Array} Blocks
     */
    editorValueToBlocks(value: any, blockContentType: any, options?: {}): any;
    /**
     ...
     */
    blocksToEditorValue(blocks: any, blockContentType: any, options?: {}): {
        object: string;
        data: {};
        document: {
            key: string;
...
export declare const editorValueToBlocks: (value: any, blockContentType: any, options?: {}) => any;
export declare const blocksToEditorValue: (blocks: any, blockContentType: any, options?: {}) => {
    object: string;
    data: {};
    document: {
        key: string;
