...
var _ImageTool = _interopRequireDefault(require("./styles/ImageTool.css"));
...
var DragAwareCanvas = (0, _makeDragAware.default)('canvas'); // The margin available in all directions for drawing the crop tool
...
function checkCropBoundaries(value, delta) {
  ...
  if (value.crop.top + delta.top < 0 || value.crop.left + delta.left < 0 || value.crop.right + delta.right < 0 || value.crop.bottom + delta.bottom < 0) {
    return false;
  }
...
var ImageTool = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(ImageTool, [{
    ...
    value: function paint(context) {
      ...
      var opacity = this.state.mousePosition ? 0.8 : 0.2;
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        className: _ImageTool.default.root
      }, /*#__PURE__*/_react.default.createElement(DragAwareCanvas, {
        className: _ImageTool.default.canvas,
        readOnly: readOnly,
        ref: this.setCanvas,
