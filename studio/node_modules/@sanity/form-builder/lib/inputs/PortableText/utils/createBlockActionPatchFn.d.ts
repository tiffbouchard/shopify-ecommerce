...
export default function createBlockActionPatchFn(type: string, block: PortableTextBlock, onPatch: (arg0: PatchEvent) => void, portableTextFeatures: PortableTextFeatures): UnsetFunction | SetFunction | InsertFunction;
export {};
