...
function OverflowMenu(props) {
  ...
  var showOverflowButton = actionStates.filter(a => !a.visible).length > 0;
  var hiddenActions = actionStates.filter(a => !a.visible);
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    arrow: true,
    className: _OverflowMenu.default.initialValueMenuTooltip,
    distance: 13,
    theme: "light",
    trigger: 'click',
    position: "bottom",
