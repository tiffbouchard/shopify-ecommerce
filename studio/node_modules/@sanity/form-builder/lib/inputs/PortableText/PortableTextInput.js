...
var _path = require("../../typedefs/path");
...
var PortableTextInputWithRef = /*#__PURE__*/_react.default.forwardRef(function PortableTextInput(props, ref) {
  ...
  var validationHash = markers.map(marker => JSON.stringify(marker.path).concat(marker.type).concat(marker.level)).sort().join('');
  ...
  var formField = (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(_default2.default, {
    description: type.description,
    label: type.title,
    level: level,
    markers: markers,
    presence: presence
  }), [markers, presence]); // Render error message and resolution

  var respondToInvalidContent = null;

  if (invalidValue) {
    respondToInvalidContent = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, formField, /*#__PURE__*/_react.default.createElement(_InvalidValue.default, {
  ...
  }, formField, !readOnly && /*#__PURE__*/_react.default.createElement("button", {
    type: "button",
    tabIndex: 0,
...
var _default = (0, _withPatchSubscriber.default)((_temp = class PortableTextInputWithFocusAndBlur extends _react.default.Component {
  constructor() {
    super(...arguments);
  ...
  render() {
    return /*#__PURE__*/_react.default.createElement(PortableTextInputWithRef, _extends({}, this.props, {
      ref: this.editorRef
    }));
  }
