...
class ArrayInput extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "renderList", () => {
      ...
      return /*#__PURE__*/_react.default.createElement(List, _extends({
        ...
        var childPresence = isGrid ? [] : presence.filter(isChildPresence);
  ...
  render() {
    ...
    }, uploadProps), /*#__PURE__*/_react.default.createElement("div", null, value && value.length > 0 && this.renderList(), this.renderUnknownValueTypes(), /*#__PURE__*/_react.default.createElement(_functions.default, {
      type: type,
      value: value,
      readOnly: readOnly,
