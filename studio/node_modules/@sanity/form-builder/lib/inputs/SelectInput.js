...
function toSelectItem(option) {
  ...
  return {
    title: (0, _capitalize2.default)(option),
    value: option
  };
}
...
class SelectInput extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "handleChange", item => {
      ...
      onChange(_PatchEvent.default.from((0, _PatchEvent.set)(typeof item === 'string' || typeof item === 'number' ? item : item.value)));
    });
  ...
  render() {
    ...
    var items = (type.options.list || []).map(toSelectItem);
