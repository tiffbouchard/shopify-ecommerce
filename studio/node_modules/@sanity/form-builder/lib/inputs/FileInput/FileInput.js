...
class FileInput extends _react.default.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "renderMaterializedAsset", assetDocument => {
      ...
      }, /*#__PURE__*/_react.default.createElement(_fileIcon.default, null)), /*#__PURE__*/_react.default.createElement("div", null, assetDocument.originalFilename, ' ', /*#__PURE__*/_react.default.createElement("a", {
  ...
  renderAdvancedEdit(fields) {
    return /*#__PURE__*/_react.default.createElement(_fullscreen.default, {
      ...
      isOpen: true
    }, /*#__PURE__*/_react.default.createElement("div", null, this.renderFields(fields)), /*#__PURE__*/_react.default.createElement(_default.default, {
  ...
  renderSelectFileButton() {
    ...
    return /*#__PURE__*/_react.default.createElement(_default.default, {
      onClick: () => console.log('add select handling here'),
      inverted: true
    }, "Select");
  }
  ...
  renderAsset() {
    ...
    return readOnly ? /*#__PURE__*/_react.default.createElement("span", null, "Field is read only") : /*#__PURE__*/_react.default.createElement(_UploadPlaceholder.default, {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_UploadTargetFieldset.default, {
      markers: markers,
      legend: type.title,
    ...
    }, uploadError && /*#__PURE__*/_react.default.createElement(_default2.default, {
      kind: "error",
      isPersisted: true,
      actionTitle: "OK",
      ...
      className: "".concat(_FileInput.default.assetWrapper, " ").concat(readOnly ? _FileInput.default.readOnly : '')
    }, value && value._upload && /*#__PURE__*/_react.default.createElement("div", {
      className: _FileInput.default.uploadState
    }, this.renderUploadState(value._upload)), this.renderAsset())), /*#__PURE__*/_react.default.createElement("div", {
      className: _FileInput.default.functions
    }, /*#__PURE__*/_react.default.createElement(_buttonGrid.default, null, !readOnly && /*#__PURE__*/_react.default.createElement(_button.default, {
      inverted: true,
      icon: _uploadIcon.default,
      onSelect: this.handleSelectFile,
      accept: accept
    }, "Upload"), value && otherFields.length > 0 && /*#__PURE__*/_react.default.createElement(_default.default, {
      icon: readOnly ? _visibilityIcon.default : _editIcon.default,
      inverted: true,
      title: readOnly ? 'View details' : 'Edit details',
      onClick: this.handleStartAdvancedEdit
    }, readOnly ? 'View details' : 'Edit'), !readOnly && hasAsset && /*#__PURE__*/_react.default.createElement(_default.default, {
      color: "danger",
      inverted: true,
      onClick: this.handleRemoveButtonClick
    }, "Remove"), isAdvancedEditOpen && this.renderAdvancedEdit(otherFields)))), highlightedFields.length > 0 && this.renderFields(highlightedFields));
  }
