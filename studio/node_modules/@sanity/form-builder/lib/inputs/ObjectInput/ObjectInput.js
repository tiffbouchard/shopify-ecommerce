...
var _ObjectInput = _interopRequireDefault(require("./styles/ObjectInput.css"));
...
class ObjectInput extends _react.default.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "_firstField", void 0);
  ...
  renderFieldset(fieldset, fieldsetIndex) {
    ...
    var fieldNames = fieldset.fields.map(f => f.name);
    var childPresence = presence.filter(item => fieldNames.includes(item.path[0]) || item.path[0] === '$');
    var isCollapsed = !isExpanded && collapsibleOpts.collapsed;
  ...
  renderUnknownFields() {
    ...
    return /*#__PURE__*/_react.default.createElement(_UnknownFields.default, {
      readOnly: readOnly,
  ...
  render() {
    ...
    if (level === 0) {
      return /*#__PURE__*/_react.default.createElement("div", {
        className: _ObjectInput.default.root
      }, /*#__PURE__*/_react.default.createElement("div", {
        className: _ObjectInput.default.fieldWrapper
