...
var _DefaultSource = _interopRequireDefault(require("./DefaultSource.css"));
...
class DefaultSource extends _react.default.Component {
  ...
  fetchPage(pageNo) {
    ...
    return _client.default.fetch(buildQuery(start, end)).then(result => {
      this.setState(prevState => ({
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_fullscreen.default, {
      cardClassName: _DefaultSource.default.card,
      title: "Select image",
      onClose: this.handleClose,
      isOpen: true
    }, /*#__PURE__*/_react.default.createElement("div", {
      className: _DefaultSource.default.imageGrid
    ...
    }))), !isLoading && assets.length === 0 && /*#__PURE__*/_react.default.createElement("div", {
      className: _DefaultSource.default.noAssets
    }, "No images found"), /*#__PURE__*/_react.default.createElement("div", {
      className: _DefaultSource.default.loadMore
    }, !isLastPage && /*#__PURE__*/_react.default.createElement(_default2.default, {
      inverted: true,
