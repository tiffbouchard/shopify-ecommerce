...
class ImageInput extends _react.default.PureComponent {
  constructor(props) {
    ...
    _defineProperty(this, "renderDropDownMenuItem", item => {
      ...
      }, /*#__PURE__*/_react.default.createElement(Icon, null)), /*#__PURE__*/_react.default.createElement("div", null, item.title));
    });
  ...
  renderAdvancedEdit(fields) {
    ...
    var Dialog = withImageTool ? _fullscreen.default : _default2.default;
    return /*#__PURE__*/_react.default.createElement(Dialog, {
      title: "Edit details",
      onClose: this.handleStopAdvancedEdit,
      isOpen: true
    }, /*#__PURE__*/_react.default.createElement(_presence.PresenceOverlay, null, /*#__PURE__*/_react.default.createElement(_content.default, {
      size: withImageTool ? 'large' : 'medium'
    ...
    }, this.renderFields(fields)), /*#__PURE__*/_react.default.createElement(_default.default, {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(FieldSetComponent, _extends({
    ...
    }, uploadProps), /*#__PURE__*/_react.default.createElement("div", null, uploadError && /*#__PURE__*/_react.default.createElement(_default4.default, {
      kind: "error",
      isPersisted: true,
      actionTitle: "OK",
      ...
      className: (0, _classnames.default)(_ImageInput.default.assetWrapper, readOnly && _ImageInput.default.readOnly, hasFocus && _ImageInput.default.focused)
