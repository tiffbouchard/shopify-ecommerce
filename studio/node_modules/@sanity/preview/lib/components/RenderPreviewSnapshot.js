...
function RenderPreviewSnapshot(props) {
  ...
  var preview = /*#__PURE__*/_react.default.createElement(PreviewComponent // Render media always until we have schema functionality for determining if there is media
  , _extends({
    media: () => undefined
  }, rest, {
    value: snapshot,
