...
var _ActionModal = _interopRequireDefault(require("./navbar/actionButton/ActionModal"));

var _SideMenu = _interopRequireDefault(require("./navbar/drawer/SideMenu"));
...
class DefaultLayout extends _react.default.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "renderContent", () => {
      ...
      }, this.state.showLoadingScreen && /*#__PURE__*/_react.default.createElement("div", {
      ...
      }))), /*#__PURE__*/_react.default.createElement(_Sidecar.default, null)), createMenuIsOpen && /*#__PURE__*/_react.default.createElement(_ActionModal.default, {
