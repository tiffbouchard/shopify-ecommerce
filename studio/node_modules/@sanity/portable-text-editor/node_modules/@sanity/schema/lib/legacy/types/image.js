...
var OVERRIDABLE_FIELDS = ['jsonType', 'type', 'name', 'title', 'description', 'options', 'fieldsets', 'validation'];
var IMAGE_CORE = {
  name: 'image',
  type: null,
  jsonType: 'object'
...
var ImageType = {
  ...
  extend(subTypeDef, extendMember) {
    ...
    if (!options.hotspot) {
      hotspotFields = hotspotFields.map(field => _objectSpread({}, field, {
        hidden: true
      }));
    }

    var fields = (subTypeDef.fields || []).concat(_fieldDefs.ASSET_FIELD).concat(hotspotFields);
