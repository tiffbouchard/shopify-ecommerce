...
export declare type RenderBlockFunction = (value: PortableTextBlock, type: Type, attributes: RenderAttributes, defaultRender: (value: PortableTextBlock) => JSX.Element, ref: React.RefObject<HTMLDivElement>) => JSX.Element;
export declare type RenderChildFunction = (value: PortableTextChild, type: Type, attributes: RenderAttributes, defaultRender: (value: PortableTextChild) => JSX.Element, ref: React.RefObject<HTMLSpanElement>) => JSX.Element;
