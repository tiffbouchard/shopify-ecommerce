...
export declare class PortableTextEditor extends React.Component<Props, State> {
    ...
    static findByPath: (editor: PortableTextEditor, path: Path) => [PortableTextBlock | {
        [other: string]: any;
        _key: string;
        _type: string;
    } | import("../types/portableText").TextSpan | undefined, Path | undefined] | undefined;
    ...
    static getSelection: (editor: PortableTextEditor) => {
        anchor: import("../types/editor").EditorSelectionPoint;
        focus: import("../types/editor").EditorSelectionPoint;
    } | null | undefined;
