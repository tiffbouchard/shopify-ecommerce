            ...
            return (react_1.default.createElement("span", Object.assign({}, attributes, { style: inlineBlockStyle }),
                react_1.default.createElement(DraggableChild_1.DraggableChild, { element: element, readOnly: readOnly, spanType: portableTextFeatures.types.span.name, keyGenerator: keyGenerator },
                    react_1.default.createElement("span", { ref: inlineBlockObjectRef, key: element._key, style: inlineBlockStyle, contentEditable: false },
                        renderChild &&
                            renderChild(values_1.fromSlateValue([element], portableTextFeatures.types.block.name)[0], type, { focused, selected, path }, defaultRender, inlineBlockObjectRef),
                        !renderChild &&
                            defaultRender(values_1.fromSlateValue([element], portableTextFeatures.types.block.name)[0]),
                        children))));
        }
        else {
    ...
    switch (element._type) {
        case portableTextFeatures.types.block.name:
            ...
            const renderedBlock = renderBlock &&
                renderBlock(values_1.fromSlateValue([element], element._type)[0], portableTextFeatures.types.block, {
                    focused,
                    selected,
            ...
            return (react_1.default.createElement("div", Object.assign({}, attributes, { className: className, key: element._key }),
                react_1.default.createElement(DraggableBlock_1.DraggableBlock, { element: element, readOnly: readOnly },
                    react_1.default.createElement(react_1.default.Fragment, null,
                        renderBlock && (react_1.default.createElement("div", { ref: blockObjectRef, contentEditable: false }, renderBlock(values_1.fromSlateValue([element], portableTextFeatures.types.block.name)[0], type, {
                            focused,
                            selected,
                            path: [{ _key: element._key }]
                        }, defaultRender, blockObjectRef))),
                        !renderBlock && (react_1.default.createElement(index_1.BlockObject, { selected: selected, className: className }, defaultRender(values_1.fromSlateValue([element], portableTextFeatures.types.block.name)[0]))),
                        children))));
    }
};
