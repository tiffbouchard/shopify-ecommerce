import { SetIfMissingPatch, InsertPatch, InsertPosition, SetPatch, UnsetPatch, DiffMatchPatch } from '../types/patch';
import { Path, PathSegment } from '../types/path';
export declare function setIfMissing(value: any, path?: Path): SetIfMissingPatch;
export declare function diffMatchPatch(currentValue: string, nextValue: string, path?: Path): DiffMatchPatch;
