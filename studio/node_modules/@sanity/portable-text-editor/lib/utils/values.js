    ...
    if (value && Array.isArray(value)) {
        return value.map(block => {
            ...
            if (isPortableText) {
                ...
                return Object.assign(Object.assign({ _type, _key }, rest), { children });
            }
        ...
        return value.map(block => {
            ...
            if (isPortableText && slate_1.Element.isElement(block)) {
                ...
                if (typeof block._key === 'string' && typeof block._type === 'string') {
                    ...
                    return Object.assign(Object.assign({ _key: block._key, _type: block._type }, block), { children });
                }
                throw new Error('Not a valid block type');
            }
            const { _key, _type } = block;
            const value = block.value;
            return Object.assign({ _key, _type }, (typeof value === 'object' ? value : {}));
        });
    }
    return value;
}
