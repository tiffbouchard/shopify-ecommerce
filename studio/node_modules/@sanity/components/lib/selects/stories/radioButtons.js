...
exports.RadioButtonsStory = RadioButtonsStory;
...
var radioItems = (0, _range2.default)(10).map((item, i) => {
  return {
    title: chance.name(),
    key: "".concat(i)
  };
...
function RadioButtonsStory() {
  var value = radioItems[(0, _knobs.number)('value', 0, {
    range: true,
    min: 0,
