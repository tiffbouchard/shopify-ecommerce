...
var chance = new _chance.default(); // @todo Make this work

function CreateDocumentStory() {
  var templateChoices = (0, _range2.default)((0, _knobs.number)('# Choices', 5, 'test')).map((choice, i) => {
    return {
      id: "".concat(i),
      title: chance.animal(),
      subtitle: 'test',
  ...
  }, /*#__PURE__*/_react.default.createElement(_createDocument.default, {
