...
var _UserAvatar = _interopRequireDefault(require("../presence/UserAvatar"));

var _PopoverList = _interopRequireDefault(require("../presence/PopoverList"));

var _PresenceListItem = require("../presence/PresenceListItem");
...
class HistoryListItem extends _react.default.PureComponent {
  ...
  render() {
    ...
    }, "Learn about history retention"))), availableUsers && availableUsers.length > 0 && /*#__PURE__*/_react.default.createElement(_PopoverList.default, {
    ...
    }, availableUsers.slice(0, MAX_USERS).map((user, i) => /*#__PURE__*/_react.default.createElement("div", {
      key: user.id,
      className: _ListItemModules.default.userAvatar
    }, /*#__PURE__*/_react.default.createElement(_UserAvatar.default, {
      user: user
    })))), availableUsers.length === 1 && /*#__PURE__*/_react.default.createElement("div", {
      className: _ListItemModules.default.userName
    }, availableUsers[0].displayName), availableUsers.length > 1 && /*#__PURE__*/_react.default.createElement("div", {
      className: _ListItemModules.default.extraItems
    }, /*#__PURE__*/_react.default.createElement("div", {
      className: _ListItemModules.default.userName
    }, availableUsers.length, " people")))), children && /*#__PURE__*/_react.default.createElement("div", {
