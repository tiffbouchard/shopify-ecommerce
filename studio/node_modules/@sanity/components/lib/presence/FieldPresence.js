...
var _PresenceOverlayRegion = require("./overlay/PresenceOverlayRegion");
...
function FieldPresencePlaceholder(props) {
...
function FieldPresenceWithOverlay(props) {
  var contextPresence = (0, _react.useContext)(_context.Context);
  ...
  return presence.length > 0 ? /*#__PURE__*/_react.default.createElement(_PresenceOverlayRegion.PresenceRegion, {
    presence: presence,
...
function FieldPresenceWithoutOverlay(props) {
  ...
  return presence.length > 0 ? /*#__PURE__*/_react.default.createElement(FieldPresenceInner, {
    presence: presence,
    maxAvatars: maxAvatars
  }) : null;
}
...
function FieldPresenceInner(_ref) {
  ...
  var sorted = (0, _sortBy2.default)(uniquePresence, presence => presence.lastActiveAt);
  ...
  var avatars = [...visible.reverse().map(visible => ({
    key: visible.user.id,
    element: /*#__PURE__*/_react.default.createElement(_UserAvatar.default, {
    ...
    key: 'counter',
    element: /*#__PURE__*/_react.default.createElement(_index.StackCounter, {
      count: hidden.length
    })
  } : null].filter(Boolean);
  var minWidth = -_constants.AVATAR_DISTANCE + (_constants.AVATAR_SIZE + _constants.AVATAR_DISTANCE) * maxAvatars;
  return /*#__PURE__*/_react.default.createElement("div", {
    className: _FieldPresence.default.root
  }, /*#__PURE__*/_react.default.createElement(_index.PopoverList, {
    items: uniquePresence,
    position: "top-end",
    trigger: "mouseenter",
    distance: 10,
    renderItem: item => /*#__PURE__*/_react.default.createElement(_PresenceListItem.PresenceListItem, {
      status: "online",
      user: item.user
    })
  ...
  }, avatars.map((av, i) => /*#__PURE__*/_react.default.createElement("div", {
    key: av.key,
    style: {
      position: 'absolute',
