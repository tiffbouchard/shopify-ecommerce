...
export declare function get(obj: any, path: Path | string, defaultVal?: unknown): any;
export declare function isEqual(path: Path, otherPath: Path): boolean;
export declare function isSegmentEqual(pathSegment: PathSegment, otherPathSegment: PathSegment): boolean;
...
export declare function randomKey(length: any): string;
