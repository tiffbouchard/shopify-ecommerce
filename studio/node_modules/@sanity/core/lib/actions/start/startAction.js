  ...
  _ensureProjectConfig = _asyncToGenerator(function* (context) {
    ...
    var _context$apiClient$co = context.apiClient({
      requireProject: false
        ...
        dataset = _context$apiClient$co.dataset; // The client wrapper returns `_dummy_` in the case where no dataset is configured,
    ...
    dataset = dataset === '_dummy_' ? undefined : dataset; // Let the user know why these values are being used
