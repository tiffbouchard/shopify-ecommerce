...
function useDocumentOperation(publishedId, typeName) {
  return (0, _useObservable.useObservable)((0, _useObservable.toObservable)({
    ...
    return _document.default.pair.editOperations(publishedId, typeName);
  }))));
}