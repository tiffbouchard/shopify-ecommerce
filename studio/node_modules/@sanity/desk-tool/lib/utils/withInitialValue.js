  ...
  var WithInitialValueStream = (0, _reactPropsStream.streamingComponent)(props$ => props$.pipe((0, _operators.switchMap)(props => {
    ...
    (0, _operators.debounceTime)(25), (0, _operators.switchMap)(document => {
      ...
      if (!shouldResolve) {
        ...
        return (0, _rxjs.of)( /*#__PURE__*/_react.default.createElement(_BrokenReferences.default, {
          document: {},
          type: documentType,
      ...
      return (0, _rxjs.merge)((0, _rxjs.of)({
        ...
        if (resolveError) {
          return (0, _rxjs.of)( /*#__PURE__*/_react.default.createElement(_errorPane.ErrorPane, null, /*#__PURE__*/_react.default.createElement("h2", null, "Failed to resolve initial value"), /*#__PURE__*/_react.default.createElement("p", null, "Check developer console for details")));
        }
        ...
        })) : /*#__PURE__*/_react.default.createElement(_BrokenReferences.default, {
