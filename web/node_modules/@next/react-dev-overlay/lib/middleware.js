...
var isWebpack5 = parseInt(webpack_1["default"].version) === 5;
function getModuleSource(compilation, module) {
    var _a, _b, _c;
    if (isWebpack5) {
        return ((_b = (module && ((_a = compilation.codeGenerationResults
...
function createOriginalStackFrame(_a) {
    var line = _a.line, column = _a.column, source = _a.source, rootDirectory = _a.rootDirectory, frame = _a.frame;
    var _b, _c, _d;
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    filePath = path_1["default"].resolve(rootDirectory, getSourcePath(sourcePosition.source));
                    originalFrame = {
                        file: sourceContent
...
function getOverlayMiddleware(options) {
    function getSourceById(isServerSide, isFile, id) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var fileContent, map_1, compilation, module_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 2:
                        try {
                            compilation = isServerSide
                                ? (_a = options.serverStats()) === null || _a === void 0 ? void 0 : _a.compilation : (_b = options.stats()) === null || _b === void 0 ? void 0 : _b.compilation;
                            if (compilation == null) {
                                return [2 /*return*/, null];
                            }
                            module_1 = __spread(compilation.modules).find(function (searchModule) { return searchModule.id === id; });
            ...
            return __generator(this, function (_q) {
                switch (_q.label) {
                    case 0:
                        ...
                        frame = query;
                        if (!((((_a = frame.file) === null || _a === void 0 ? void 0 : _a.startsWith('webpack-internal:///')) || ((_b = frame.file) === null || _b === void 0 ? void 0 : _b.startsWith('file://'))) &&
